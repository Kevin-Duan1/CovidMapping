...
1. An introduction to the research question you are seeking to answer or explore

2. One or more displays that helps the audience understand the data you are working with

3. One or more displays from the initial exploratory phase of your data analysis

4. One or more displays that include your model/analysis of the data
These may include diagnostic plots, informal comparisons, tests for assumptions, etc.

5.One or more displays that supports the conclusion/answer to your research question

```{r data}
#load in the relevant data
#taken from https://www.kaggle.com/datasets/paultimothymooney/usa-covid19-vaccinations
vacc <- read.csv("D:/School Work/Data Visualization/us_state_vaccinations.csv")

#taken from https://healthdata.gov/dataset/United-States-COVID-19-Cases-and-Deaths-by-State-o/hiyb-zgc2
covcases <- read.csv("D:/School Work/Data Visualization/US _cases by State_Time.csv")
colnames(covcases)[which(names(covcases) == "state")]<- "abb"

states <- data.frame(state = state.name, abb = state.abb)

#taken from https://data.census.gov/cedsci/table?tid=PEPPOP2021.NST_EST2021_POP
usapop <- read_excel("D:/NST-EST2021-POP.xlsx", sheet = 2)
usapop$State <- substring(usapop$State, 2)
